...
int main () {
    ...
    do {
        do {
            printf ( " Zorluk Seviyesi seçiniz ( Zor = 1, Orta = 2, Kolay = 3 ) :  " ) ;
                scanf ( "%d", &zorluk_seviyesi ) ;
    
            if ( zorluk_seviyesi == 1 ) {
                game.speed = 10 ;   }
    
            else if ( zorluk_seviyesi == 2 ) {
                game.speed = 50 ;   }
    
            else if ( zorluk_seviyesi == 3) {
                game.speed = 100 ;  }

            else {
                printf ( "Geçersiz değer girdiniz" ) ;  }
            } while (zorluk_seviyesi != 1 && zorluk_seviyesi != 2 && zorluk_seviyesi != 3 ) ;
